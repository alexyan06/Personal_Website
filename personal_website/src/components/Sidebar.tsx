...
import { navLinks, socialLinks } from "../constants/index.tsx";
      ...
      <Sheet>
        <SheetTrigger asChild>
          <Button
            variant='ghost'
            size='icon'
            className='m-4 fixed top-4 right-4 z-50 border-2
            ...
            {navLinks.map((link) => {
              ...
              return (
                <a
                  ...
                  className={cn(
                    'text-neutral-300 flex items-center gap-2 ' +
                    'hover:text-primary transition-colors ' +
                    'duration-200 text-base', active===link.link &&
                    'text-primary'
                  )}
                >
